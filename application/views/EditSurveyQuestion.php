<div id="content-wrapper">
		...
		<div class="page-header">
			<h1><span class="text-light-gray"><a href="<?php echo site_url(); ?>all-questions">edit-survey-question Bank<a>/ </span>
            Edit Question</h1>
		</div> <!-- / .page-header -->
...
-->
		   ...
		   <?php 
            ...
            echo form_open('edit-survey-question?qid='.$_GET['qid'],$attributes); ?>
            <!-- / Javascript -->
